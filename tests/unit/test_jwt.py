...
from hygroup.web.auth.jwt import create_access_token, get_current_username, verify_token
...
def test_verify_token_wrong_secret(settings):
    ...
    wrong_settings = AppSettings(jwt_secret_key="wrong-secret-key", jwt_algorithm="HS256", jwt_expiration_days=7)
