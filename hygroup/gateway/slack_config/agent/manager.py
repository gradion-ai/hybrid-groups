...
from hygroup.gateway.slack_config.agent.validator import AgentValidator
...
class AgentConfigManager:
    ...
    async def _get_agents(self) -> list[AgentListViewModel]:
        agents = []
        for agent_name, config in (await self._agent_registry.get_agent_configurations()).items():
            agents.append(
                AgentListViewModel(
                    name=agent_name,
