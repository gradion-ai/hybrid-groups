...
from hygroup.gateway.slack_config.models import AgentListViewModel, AgentViewModel
            ...
            blocks.append(
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "View available agents in the system.",
                    },
                }
            )
    ...
    def build_agent_form_modal(agent: AgentViewModel | None = None, is_edit: bool = False) -> Dict[str, Any]:
        ...
        model_block: Dict[str, Any] = {
            ...
            "element": {
                ...
                "placeholder": {
                    "type": "plain_text",
                    "text": 'openai:gpt-4.1 or {"provider": "openai", "model": "gpt-4.1"}',
                },
            },
            "hint": {
                "type": "plain_text",
                "text": "Enter model name ('openai:gpt-4.1') or model configuration (e.g., {'provider': 'openai', 'model': 'gpt-4.1'})",
            },
        }
        ...
        mcp_settings_block: Dict[str, Any] = {
            ...
            "hint": {
                "type": "plain_text",
                "text": "JSON array of MCP server configurations. Example: [{'command': 'node', 'args': ['server.js'], 'env': {'VAR': 'value'}}]",
            },
        }
